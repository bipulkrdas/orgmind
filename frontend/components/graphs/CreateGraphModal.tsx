...
import { createGraph } from '@/lib/api/graphs';
...
export default function CreateGraphModal({ isOpen, onClose, onSuccess }: CreateGraphModalProps) {
  ...
  const handleChange = (field: keyof CreateGraphRequest, value: string) => {
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Create New Graph</h3>
                <button
                  type="button"
                  onClick={handleClose}
                  disabled={isLoading}
